...
**Response**: the three box plots are labeled Adelie (red), chinstrap(green), and gentoo(blue). The Gentoo species has the larger flipper length in this chart
...
**Response**: The boxplot strenth is you can easily see the median in the dataset. The benefit to the jitterplot is we can see the density of the datapoints easily in this graph. 
...
**Response**: The md file is easier to read and more professional - it includes graphics and is formatted better
...
**Response**:The box plot being underneath the jitterplot allows you to see all of the jitterplot and see the box plot.
...
**Response**:When mapping in the ggplot it will color all of the plots - when putting it only in the boxplot layer it will color the boxplots. 
